...
internal partial class BmsPanelBeatmapStandalone
{
    public partial class SpreadDisplay : OsuAnimatedButton
    {
        public Bindable<BeatmapInfo?> Beatmap { get; } = new();

        public Bindable<StarDifficulty> StarDifficulty { get; } = new();
        ...
        private readonly Bindable<bool> showConvertedBeatmaps = new();
        ...
        private void updateBeatmap()
        {
            ...
            {
                var otherStarDifficulty = otherStarDifficulties[i];
            ...
            var countNotShown = otherStarDifficulties.Count - (preceding.Count + succeeding.Count);
            ...
            {
                for (var i = 0; i < succeeding.Count; ++i)
                {
        ...
        {
            var isInteractable = Enabled.Value && IsHovered;
