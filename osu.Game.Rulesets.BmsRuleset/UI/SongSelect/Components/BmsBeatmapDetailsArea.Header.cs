...
public partial class BmsBeatmapDetailsArea
{
    public partial class Header : CompositeDrawable
    {
        ...
        private readonly Bindable<BeatmapDetailTab> configDetailTab = new();

        public IBindable<LeaderboardSortMode> Sorting => sortDropdown.Current;

        private readonly Bindable<LeaderboardSortMode> configLeaderboardSortMode = new();
        ...
        private void load(OsuConfigManager config)
        {
            ...
            [
                new Container
                {
                    ...
                    Padding = new MarginPadding { Left = BmsSongSelect.WEDGE_CONTENT_MARGIN, Right = 5f },
                    Children =
                    [
