...
public static class BmsJudgementProfileProvider
{
    ...
    private static BmsJudgementProfile createProfile(BmsLayoutVariant layout, int rank)
        => layout switch
        {
            ...
            BmsLayoutVariant.Pms9K or BmsLayoutVariant.Pms9K2P or BmsLayoutVariant.Pms9KDouble => pms(rank),
            _ => sevenKeys(rank),
        };
    ...
    private static BmsJudgementProfile pms(int rank) => new(
        pmsHead(rank, (-20, 20), (-50, 50), (-117, 117), (-183, 183), (-175, 500)),
        pmsHead(rank, (-20, 20), (-50, 50), (-117, 117), (-183, 183), (-175, 500)),
        pmsTail(rank, (-120, 120), (-150, 150), (-217, 217), (-283, 283)),
        pmsTail(rank, (-120, 120), (-150, 150), (-217, 217), (-283, 283)));
