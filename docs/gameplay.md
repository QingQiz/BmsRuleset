...
| Visual offset                 | 0 ms     | -500–500 ms, step 1 ms                    | Moves scrolling visuals only. Positive values display notes earlier for players who receive more Late judgements; negative values display them later for players who receive more Fast judgements. Audio, judgements, scoring, and keysounds remain unchanged. |
