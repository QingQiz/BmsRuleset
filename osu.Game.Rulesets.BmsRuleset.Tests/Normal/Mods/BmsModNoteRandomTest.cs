...
public class BmsModNoteRandomTest
{
    ...
    public void TestLongNoteBlocksSubsequentNotesOnSameColumn()
    {
        ...
        beatmap.HitObjects.Add(new BmsHitObject { StartTime = 1000, Column = 3, IsLongNote = true, Duration = 500 });
        beatmap.HitObjects.Add(new BmsHitObject { StartTime = 1100, Column = 1 });

        var mod = new BmsModNoteRandom { IncludeScratch = { Value = true }, Seed = { Value = 42 } };
        applyMod(mod, beatmap);

        var lnColumn = beatmap.HitObjects.Single(h => h.IsLongNote).Column;
        var regularColumn = beatmap.HitObjects.Single(h => !h.IsLongNote).Column;
    ...
    public void TestLongNoteColumnFreedAfterDuration()
    {
        ...
        beatmap.HitObjects.Add(new BmsHitObject { StartTime = 1000, Column = 0, IsLongNote = true, Duration = 200 });
