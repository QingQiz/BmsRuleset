...
public class BmsBgaDisplaySizingTest
{
    ...
    public void TestFullCanvasImageFitsAspectInsideBgaComponent()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(sprite.Size, Is.EqualTo(new Vector2(1)));
    ...
    {
        using var parent = new Container { Child = new BmsBgaDisplay { Depth = float.MaxValue } };
        var clone = (BmsBgaDisplay)parent.Child;
