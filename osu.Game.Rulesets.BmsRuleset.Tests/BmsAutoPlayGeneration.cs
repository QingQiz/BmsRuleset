...
public partial class BmsAutoPlayGeneration : OsuTestScene
{
    ...
    {
        var beatmap = createBeatmap(new BmsHitObject { StartTime = 1000, Column = 1, IsLongNote = true, Duration = 2000 });
    ...
    {
        var beatmap = createBeatmap(
            new BmsHitObject { StartTime = 1000, Column = 1, IsLongNote = true, Duration = 2000 },
            new BmsHitObject { StartTime = 1000, Column = 2, IsLongNote = true, Duration = 2000 });
    ...
    public void TestLongNoteStair()
    {
        var beatmap = createBeatmap(
            new BmsHitObject { StartTime = 1000, Column = 1, IsLongNote = true, Duration = 2000 },
            new BmsHitObject { StartTime = 2000, Column = 2, IsLongNote = true, Duration = 2000 });
